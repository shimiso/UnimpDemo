...
import com.example.unimpdemo.common.Constants;
import java.io.File;
...
public class SharePreferenceUtil {
    ...
    public String getFileTempPath() {
        String bitmapCachePath = getBasePath() + context.getString(R.string.file_temp);
        File dirFile = new File(bitmapCachePath);
        if (!dirFile.exists()) {
            dirFile.mkdirs();
        }
     ...
     * 存储语音指令权限
     *
     * @param commandListKey      存储的key值
     * @param commandListValue 默认值
     */
    public String getUserCommandList(String commandListKey, String commandListValue) {
        return sp.getString(commandListKey, commandListValue);
    }
    /**
     * 存取语音指令权限
     *
     * @param commandListKey   存储的key值
     * @param commandListValue 存储的boolean值
     */
    public void setUserCommandList(String commandListKey, String commandListValue) {
        SharedPreferences.Editor edit = sp.edit();
        edit.putString(commandListKey, commandListValue);
        edit.apply();
    }
    /**
     * 获取WIFI集合
     *
     * @param WIFIListKey      存储的key值
     * @param WIFIListValue 默认值
     */
    public String getWIFIList(String WIFIListKey, String WIFIListValue) {
        return sp.getString(WIFIListKey, WIFIListValue);
    }
    /**
     * 存储WIFI集合
     *
     * @param WIFIListKey   存储的key值
     * @param WIFIListValue 存储的boolean值
     */
    public void setWIFIList(String WIFIListKey, String WIFIListValue) {
        SharedPreferences.Editor edit = sp.edit();
        edit.putString(WIFIListKey, WIFIListValue);
        edit.apply();
    }
    /**
     * 获取经纬度
     *
     * @param LocationsListKey      存储的key值
     * @param LocationsListValue 默认值
     */
    public String getLocationsList(String LocationsListKey, String LocationsListValue) {
        return sp.getString(LocationsListKey, LocationsListValue);
    }
    /**
     * 存储经纬度
     *
     * @param LocationsListKey   存储的key值
     * @param LocationsListValue 存储的boolean值
     */
    public void setLocationsList(String LocationsListKey, String LocationsListValue) {
        SharedPreferences.Editor edit = sp.edit();
        edit.putString(LocationsListKey, LocationsListValue);
        edit.apply();
    }
}
